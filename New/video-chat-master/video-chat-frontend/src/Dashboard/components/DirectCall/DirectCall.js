...
import LocalVideoRemoteView from '../LocalVideoView/LocalVideoRemoteView';
...
const DirectCall = (props) => {
  ...
  return (
    <>
      {callState !== callStates.CALL_IN_PROGRESS && <LocalVideoRemoteView localStream={localStream}/> }
      {callState === callStates.CALL_IN_PROGRESS && <LocalVideoView localStream={localStream} /> }
